...
.controller("ContentController", ["$scope",function($scope){
  ...
  $scope.allAboutMe = [
    ...
    {"nameId":"i-am-vietnamese","content":"I flew from Vietnam to the USA nine years ago.", "bgColor":"#FCF09E"},

    {"nameId":"i-speak", "content":"I speak JavaScript, HTML, and CSS.", "bgColor":""},

    {"nameId":"i-breathe", "content":"I breathe User Experience.", "bgColor":"lightblue"},

    {"nameId":"i-dance", "content":"When I'm not designing, am playing soccer and (break)dancing.", "bgColor":"#000","color":"#fff"}
