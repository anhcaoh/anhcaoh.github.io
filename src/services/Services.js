...
class Services extends Component {
    render() {
        const services = [
            ...
            description: 'From project conceptual to the finishing touch, we put design first and foremost in every aspects of customer experiences.',
            ...
            description: 'Data-driven EAS development: To solve complex business requirements by leveraging the latest and greatest technologies:',
